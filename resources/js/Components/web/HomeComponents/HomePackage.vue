    ...
    <div v-if="loading">
      ...
      <slide v-for="pack in 5" :key="pack">
        ...
        <div class="card m-1 h-100 w-100">
          <b-skeleton type="image" animation="fade" class="card-img-top" style="height: 12.5rem"></b-skeleton>
          <div class="card-body pb-0">
            ...
            <hr class="pb-2 m-0" />
              <b-skeleton animation="fade"  class="card-text pt-3" width="100%"></b-skeleton>
              <b-skeleton animation="fade" class="card-text pt-3"  width="95%"></b-skeleton>
              <b-skeleton animation="fade" class="card-text pt-3"  width="90%"></b-skeleton>
