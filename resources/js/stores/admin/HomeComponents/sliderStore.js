    ...
    actions: {
        ...
        deleteHomeSlider(id) {
            Swal.fire({
                title: "Are you sure?",
                text:
                    "Do you want to Delete Permanently this Home Slider : " +
                    id,
                icon: "warning",
